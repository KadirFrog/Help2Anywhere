    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_id', models.CharField(blank=True, default='0', max_length=10)),
                ('school_class', models.CharField(blank=True, max_length=10)),
                ('telephone_number', models.CharField(blank=True, max_length=15)),
                ('can_post', models.DecimalField(decimal_places=0, default=1, max_digits=1)),
                ('is_teacher', models.DecimalField(decimal_places=0, default=0, max_digits=1)),
                ('is_verified', models.DecimalField(decimal_places=0, default=0, max_digits=1)),
